{$pageName = 'Packages Page | User Dashboard '}
                                                                    ...
                                                                    <td class=item>
                                                                        <table cellspacing=1 cellpadding=2 border=0
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class=inheader width=200>Amount
                                                                                    Spent ({$currency_sign})
                                                                                </td>
                                                                                <td class=inheader width=100 nowrap>
                                                                                    <nobr>{$plans[plans].period} Profit
                                                                                        (%)
                                                                                    </nobr>
                                                                                </td>
                                                                            </tr>
                                                                            {section name=plan_options loop=$plans[plans].plans}
                                                                                <tr>
                                                                                    ...
                                                                                    <td class=item
                                                                                        align=right>{$plans[plans].plans[plan_options].deposit}</td>
                                                                                    <td class=item
                                                                                        align=right>{$plans[plans].plans[plan_options].percent}</td>
                                                                                </tr>
                                                                            {/section}
                                                                        </table>
                                                                        <br>
                                                                        <table cellspacing=1 cellpadding=2 border=0
                                                                            ...
                                                                            {if !$plans[plans].deposits}
                                                                                <tr>
                                                                                    <td colspan=4><b>No deposits for
                                                                                            this plan</b></td>
                                                                                </tr>
                                                                            {else}
                                                                                <tr>
                                                                                    <td colspan=4 class=inheader
                                                                                        style="text-align:left">Your
                                                                                        deposits:
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                ...
                                                                                {section name=deposit loop=$plans[plans].deposits}
                                                                                    <tr>
                                                                                        <td align=center class=item>
                                                                                            <b>{$plans[plans].deposits[deposit].date}</b><br>Expire
                                                                                            in {$plans[plans].deposits[deposit].expire_in}
                                                                                            days
                                                                                        </td>
                                                                                        <td align=right class=item>
                                                                                            <b>{$currency_sign}{$plans[plans].deposits[deposit].deposit}
                                                                                                <img src="images/{$plans[plans].deposits[deposit].ec}.gif"
                                                                                                     align=absmiddle
                                                                                                     hspace=1 height=17></b>
                                                                                        </td>
                                                                                        {if $plans[plans].use_compound}
                                                                                            <td align=center class=item
                                                                                                align=center>{$plans[plans].deposits[deposit].compound}
                                                                                                %
                                                                        ...
                                                                        {if $plans[plans].total_deposit > 0 || $plans[plans].today_profit > 0 || $plans[plans].total_profit > 0}
                                                                            <table cellspacing=0 cellpadding=1 border=0>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <b>{$currency_sign}{$plans[plans].total_deposit}</b>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>Profit Today:</td>
                                                                                    <td>
                                                                                        <b>{$currency_sign}{$plans[plans].today_profit}</b>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>Total Profit:</td>
                                                                                    <td>
                                                                                        <b>{$currency_sign}{$plans[plans].total_profit}</b>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        {/if}
