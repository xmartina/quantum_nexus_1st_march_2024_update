                            ...
                            <form action="index.php" method=post onsubmit="return checkform()" name=editform>
                                ...
                                {if $errors}
                                    <ul style="color:red">
                                        ...
                                        <li>Password is too small, please enter at
                                            least {$settings.min_user_password_length} chars!
                                            {/if}
                                            {if $errors[e] eq 'transaction_code'}
                                        <li>Please enter the Transaction
                                            Code! {/if} {if $errors[e] eq 'transaction_code_confirm'}
                                        <li>Please check your Transaction Code!
                                            {/if}
                                            {if $errors[e] eq 'transaction_code_too_small'}
                                        <li>Transaction Code is too small, please enter at
                                            least {$settings.min_user_password_length} chars!
                                            {/if}
                                ...
                                <table cellspacing=0 cellpadding=2 border=0>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type=text name=fullname value='{$userinfo.name|escape:"quotes"}'
                                    ...
                                    {if $settings.use_user_location}
                                        <tr>
                                            ...
                                            <td><input type=text name=address
                                                       value="{$userinfo.address|escape:"quotes"}" class="form-control "
                                                       size=30></td>
                                        </tr>
                                        <tr>
                                            <td>Your City:</td>
                                    ...
                                    {if $userinfo.admin_auto_pay_earning == 1}
                                        <tr>
                                            <td colspan=2><input type=checkbox name=user_auto_pay_earning value=1
                                                ...
                                                Receive earnings directly to e-currency account
                                            </td>
                                        </tr>
                                    {/if}
